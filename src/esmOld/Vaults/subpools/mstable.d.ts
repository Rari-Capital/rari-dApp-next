...
export default class mStableSubpool {
    ...
    getIMUsdVaultWeeklyRoi(totalStakingRewards: any, stakingTokenPrice: any): Promise<number>;
    getIMUsdVaultApy(totalStakingRewards: any, stakingTokenPrice: any): Promise<BigNumber>;
}
