...
export default class JumpRateModelV2 {
    ...
    _init(provider: Web3Provider, interestRateModelAddress: string, reserveFactorMantissa: BigNumberish, adminFeeMantissa: BigNumberish, fuseFeeMantissa: BigNumberish): Promise<void>;
