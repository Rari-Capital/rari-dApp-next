...
export default class JumpRateModelV2 {
  init(interestRateModelAddress, assetAddress, provider) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.baseRatePerBlock = toBN(
        yield jumpRateModelContract.callStatic.baseRatePerBlock()
      );
      this.multiplierPerBlock = toBN(
        yield jumpRateModelContract.callStatic.multiplierPerBlock()
      );
      this.jumpMultiplierPerBlock = toBN(
        yield jumpRateModelContract.callStatic.jumpMultiplierPerBlock()
      );
      ...
      this.reserveFactorMantissa = toBN(
        yield cTokenContract.callStatic.reserveFactorMantissa()
      );
      this.reserveFactorMantissa = this.reserveFactorMantissa.add(
        toBN(yield cTokenContract.callStatic.adminFeeMantissa())
      );
      this.reserveFactorMantissa = this.reserveFactorMantissa.add(
        toBN(yield cTokenContract.callStatic.fuseFeeMantissa())
      );
  ...
  _init(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.reserveFactorMantissa = this.reserveFactorMantissa.add(
        toBN(adminFeeMantissa)
      );
      this.reserveFactorMantissa = this.reserveFactorMantissa.add(
        toBN(fuseFeeMantissa)
      );
      this.initialized = true;
    });
  }
...
JumpRateModelV2.RUNTIME_BYTECODE_HASH =
