  ...
  init(interestRateModelAddress, assetAddress, provider) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.baseRatePerBlock = toBN(
        yield whitePaperModelContract.callStatic.baseRatePerBlock()
      );
      this.multiplierPerBlock = toBN(
        yield whitePaperModelContract.callStatic.multiplierPerBlock()
      );
...
WhitePaperInterestRateModel.RUNTIME_BYTECODE_HASH =
