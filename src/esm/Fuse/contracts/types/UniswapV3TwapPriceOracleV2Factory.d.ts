...
export interface UniswapV3TwapPriceOracleV2FactoryInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "oracles", values: [string, BigNumberish, string]): string;
...
export interface UniswapV3TwapPriceOracleV2Factory extends BaseContract {
    ...
    functions: {
         ...
         */
        oracles(arg0: string, arg1: BigNumberish, arg2: string, overrides?: CallOverrides): Promise<[string]>;
        /**
         ...
         */
        deploy(uniswapV3Factory: string, feeTier: BigNumberish, baseToken: string, overrides?: Overrides & {
    ...
    callStatic: {
         ...
         * @param uniswapV3Factory The `UniswapV3Factory` contract of the pairs for which this oracle will be used.
         */
        deploy(uniswapV3Factory: string, feeTier: BigNumberish, baseToken: string, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
         ...
         * Maps `UniswapV3Factory` contracts to fee tiers to base tokens to `UniswapV3TwapPriceOracleV2` contract addresses.
         */
        oracles(arg0: string, arg1: BigNumberish, arg2: string, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Deploys a `UniswapV3TwapPriceOracleV2`.
         * @param baseToken The base token of the pairs for which this oracle will be used.
         * @param feeTier The fee tier of the pairs for which this oracle will be used.
    ...
    populateTransaction: {
         ...
         * Maps `UniswapV3Factory` contracts to fee tiers to base tokens to `UniswapV3TwapPriceOracleV2` contract addresses.
         */
        oracles(arg0: string, arg1: BigNumberish, arg2: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Deploys a `UniswapV3TwapPriceOracleV2`.
         * @param baseToken The base token of the pairs for which this oracle will be used.
         * @param feeTier The fee tier of the pairs for which this oracle will be used.
