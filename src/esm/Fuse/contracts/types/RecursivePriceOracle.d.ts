...
export interface RecursivePriceOracleInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "COMPOUND_COMPTROLLER", values?: undefined): string;
    encodeFunctionData(functionFragment: "CREAM_COMPTROLLER", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "COMPOUND_COMPTROLLER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "CREAM_COMPTROLLER", data: BytesLike): Result;
...
export interface RecursivePriceOracle extends BaseContract {
    ...
    populateTransaction: {
        COMPOUND_COMPTROLLER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
