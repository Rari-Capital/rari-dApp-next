...
export interface ChainlinkPriceOracleInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "BTC_ETH_PRICE_FEED", values?: undefined): string;
    encodeFunctionData(functionFragment: "ETH_USD_PRICE_FEED", values?: undefined): string;
    encodeFunctionData(functionFragment: "btcPriceFeeds", values: [string]): string;
    encodeFunctionData(functionFragment: "ethPriceFeeds", values: [string]): string;
    encodeFunctionData(functionFragment: "maxSecondsBeforePriceIsStale", values?: undefined): string;
    encodeFunctionData(functionFragment: "usdPriceFeeds", values: [string]): string;
    encodeFunctionData(functionFragment: "hasPriceFeed", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "BTC_ETH_PRICE_FEED", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ETH_USD_PRICE_FEED", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "btcPriceFeeds", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ethPriceFeeds", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "maxSecondsBeforePriceIsStale", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "usdPriceFeeds", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hasPriceFeed", data: BytesLike): Result;
...
export interface ChainlinkPriceOracle extends BaseContract {
    ...
    estimateGas: {
         ...
         * Returns a boolean indicating if a price feed exists for the underlying asset.
         */
        hasPriceFeed(underlying: string, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Returns the price in ETH of `underlying` (implements `BasePriceOracle`).
         */
        price(underlying: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
         ...
         * Chainlink BTC/ETH price feed contracts.
         */
        BTC_ETH_PRICE_FEED(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Chainlink ETH/USD price feed contracts.
         */
         ...
         * Maps ERC20 token addresses to BTC-based Chainlink price feed contracts.
         */
        btcPriceFeeds(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Maps ERC20 token addresses to ETH-based Chainlink price feed contracts.
         */
        ethPriceFeeds(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * The maxmimum number of seconds elapsed since the round was last updated before the price is considered stale. If set to 0, no limit is enforced.
         */
        maxSecondsBeforePriceIsStale(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Maps ERC20 token addresses to USD-based Chainlink price feed contracts.
         */
        usdPriceFeeds(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Returns a boolean indicating if a price feed exists for the underlying asset.
         */
        hasPriceFeed(underlying: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Returns the price in ETH of `underlying` (implements `BasePriceOracle`).
         */
