...
export interface FusePoolLensInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getPublicPoolsByVerificationWithData", values: [boolean]): string;
...
export interface FusePoolLens extends BaseContract {
    ...
    functions: {
        ...
        initialize(_directory: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPublicPoolsWithData(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPublicPoolsByVerificationWithData(whitelistedAdmin: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPoolsByAccountWithData(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPoolSummary(comptroller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPoolAssetsWithData(comptroller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPublicPoolUsersWithData(maxHealth: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "getPoolUsersWithData(address[],uint256)"(comptrollers: string[], maxHealth: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "getPoolUsersWithData(address,uint256)"(comptroller: string, maxHealth: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPoolsBySupplier(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getPoolsBySupplierWithData(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getUserSummary(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPoolUserSummary(comptroller: string, account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getWhitelistedPoolsByAccount(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getWhitelistedPoolsByAccountWithData(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    directory(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        getPublicPoolsWithData(overrides?: CallOverrides): Promise<[
            BigNumber[],
            FusePoolStructOutput[],
            FusePoolDataStructOutput[],
            boolean[]
        ]>;
        getPublicPoolsByVerificationWithData(whitelistedAdmin: boolean, overrides?: CallOverrides): Promise<[
            BigNumber[],
            FusePoolStructOutput[],
            FusePoolDataStructOutput[],
            boolean[]
        ]>;
        getPoolsByAccountWithData(account: string, overrides?: CallOverrides): Promise<[
            BigNumber[],
            FusePoolStructOutput[],
            FusePoolDataStructOutput[],
            boolean[]
        ]>;
        getPoolSummary(comptroller: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, string[], string[], boolean]>;
        getPoolAssetsWithData(comptroller: string, overrides?: CallOverrides): Promise<FusePoolAssetStructOutput[]>;
        getPublicPoolUsersWithData(maxHealth: BigNumberish, overrides?: CallOverrides): Promise<[
            string[],
        ...
        "getPoolUsersWithData(address[],uint256)"(comptrollers: string[], maxHealth: BigNumberish, overrides?: CallOverrides): Promise<[
            FusePoolUserStructOutput[],
            BigNumber[],
            BigNumber[],
            boolean[]
        ]>;
        "getPoolUsersWithData(address,uint256)"(comptroller: string, maxHealth: BigNumberish, overrides?: CallOverrides): Promise<[FusePoolUserStructOutput[], BigNumber, BigNumber]>;
        getPoolsBySupplier(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getPoolsBySupplierWithData(account: string, overrides?: CallOverrides): Promise<[
            BigNumber[],
            FusePoolStructOutput[],
            FusePoolDataStructOutput[],
            boolean[]
        ...
        getPoolUserSummary(comptroller: string, account: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        getWhitelistedPoolsByAccount(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getWhitelistedPoolsByAccountWithData(account: string, overrides?: CallOverrides): Promise<[
            BigNumber[],
            FusePoolStructOutput[],
            FusePoolDataStructOutput[],
            boolean[]
