...
export interface FusePoolDirectoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deployPool", values: [string, string, boolean, BigNumberish, BigNumberish, string]): string;
...
export declare type AdminWhitelistUpdatedEventFilter = TypedEventFilter<AdminWhitelistUpdatedEvent>;
...
export interface FusePoolDirectory extends BaseContract {
    ...
    functions: {
        ...
        initialize(_enforceDeployerWhitelist: boolean, _deployerWhitelist: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _setDeployerWhitelistEnforcement(enforce: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _editDeployerWhitelist(deployers: string[], status: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployPool(name: string, implementation: string, enforceWhitelist: boolean, closeFactor: BigNumberish, liquidationIncentive: BigNumberish, priceOracle: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getAllPools(overrides?: CallOverrides): Promise<[FusePoolStructOutput[]]>;
        getPublicPools(overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getPoolsByAccount(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getBookmarks(account: string, overrides?: CallOverrides): Promise<[string[]]>;
        bookmarkPool(comptroller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setPoolName(index: BigNumberish, name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _editAdminWhitelist(admins: string[], status: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getPublicPoolsByVerification(whitelistedAdmin: boolean, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
    };
    adminWhitelist(arg0: string, overrides?: CallOverrides): Promise<boolean>;
    deployerWhitelist(arg0: string, overrides?: CallOverrides): Promise<boolean>;
    enforceDeployerWhitelist(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        initialize(_enforceDeployerWhitelist: boolean, _deployerWhitelist: string[], overrides?: CallOverrides): Promise<void>;
        ...
        deployPool(name: string, implementation: string, enforceWhitelist: boolean, closeFactor: BigNumberish, liquidationIncentive: BigNumberish, priceOracle: string, overrides?: CallOverrides): Promise<[BigNumber, string]>;
        getAllPools(overrides?: CallOverrides): Promise<FusePoolStructOutput[]>;
        getPublicPools(overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getPoolsByAccount(account: string, overrides?: CallOverrides): Promise<[BigNumber[], FusePoolStructOutput[]]>;
        getBookmarks(account: string, overrides?: CallOverrides): Promise<string[]>;
