...
export interface YVaultV1PriceOracleInterface extends utils.Interface {
    functions: {
...
export interface YVaultV1PriceOracle extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: YVaultV1PriceOracleInterface;
