...
export interface FuseSafeLiquidatorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "redeemCustomCollateral",
...
export interface FuseSafeLiquidator extends BaseContract {
  ...
  functions: {
    "safeLiquidate(address,address,address,uint256,address,address,address[],bytes[])"(
      borrower: string,
      cEther: string,
      cErc20Collateral: string,
      minOutputAmount: BigNumberish,
      exchangeSeizedTo: string,
    ...
    safeLiquidateToTokensWithFlashLoan(
      ...
      exchangeProfitTo: string,
      uniswapV2RouterForBorrow: string,
      uniswapV2RouterForCollateral: string,
      redemptionStrategies: string[],
      strategyData: BytesLike[],
      ethToCoinbase: BigNumberish,
      overrides?: Overrides & {
        from?: string | Promise<string>;
      }
    ): Promise<ContractTransaction>;
    ...
    redeemCustomCollateral(
      ...
      underlyingCollateralSeized: BigNumberish,
      strategy: string,
      strategyData: BytesLike,
      overrides?: Overrides & {
        from?: string | Promise<string>;
