...
export interface UniswapTwapPriceOracleV2FactoryInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "oracles", values: [string, string]): string;
    encodeFunctionData(functionFragment: "rootOracle", values?: undefined): string;
    encodeFunctionData(functionFragment: "deploy", values: [string, string]): string;
...
export interface UniswapTwapPriceOracleV2Factory extends BaseContract {
    ...
    functions: {
         ...
         */
        oracles(arg0: string, arg1: string, overrides?: CallOverrides): Promise<[string]>;
         ...
         */
        deploy(uniswapV2Factory: string, baseToken: string, overrides?: Overrides & {
    ...
    callStatic: {
         ...
         * @param uniswapV2Factory The `UniswapV2Factory` contract of the pairs for which this oracle will be used.
         */
        deploy(uniswapV2Factory: string, baseToken: string, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
         ...
         * Maps `UniswapV2Factory` contracts to base tokens to `UniswapTwapPriceOracleV2` contract addresses.
         */
        oracles(arg0: string, arg1: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
         ...
         * Maps `UniswapV2Factory` contracts to base tokens to `UniswapTwapPriceOracleV2` contract addresses.
         */
        oracles(arg0: string, arg1: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
