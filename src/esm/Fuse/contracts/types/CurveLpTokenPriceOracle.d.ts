...
export interface CurveLpTokenPriceOracleInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "underlyingTokens", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "registerPool", values: [string]): string;
    decodeFunctionResult(functionFragment: "poolOf", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "registry", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "underlyingTokens", data: BytesLike): Result;
...
export interface CurveLpTokenPriceOracle extends BaseContract {
    ...
    functions: {
        ...
        underlyingTokens(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        /**
         ...
         */
        registerPool(lpToken: string, overrides?: Overrides & {
    ...
    estimateGas: {
        ...
        underlyingTokens(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        /**
         * Get the LP token price price for an underlying token address.
         * @param underlying The underlying token address for which to get the price (set to zero address for ETH).
         */
    ...
    populateTransaction: {
        poolOf(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        registry(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        underlyingTokens(arg0: string, arg1: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        /**
         * Get the LP token price price for an underlying token address.
         * @param underlying The underlying token address for which to get the price (set to zero address for ETH).
         */
