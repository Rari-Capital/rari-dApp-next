...
export interface FuseFeeDistributorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "_latestCErc20Delegate",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "_latestCEtherDelegate",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "cErc20DelegateWhitelist",
    values: [string, string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "cEtherDelegateWhitelist",
    values: [string, string, boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "comptrollerImplementationWhitelist",
  ...
  encodeFunctionData(
    functionFragment: "_callPool",
    values: [string[], BytesLike[]]
  ): string;
  encodeFunctionData(
    functionFragment: "deployCEther",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "_editComptrollerImplementationWhitelist",
    values: [string[], string[], boolean[]]
  ): string;
  encodeFunctionData(
    functionFragment: "_editCErc20DelegateWhitelist",
    values: [string[], string[], boolean[], boolean[]]
  ): string;
  encodeFunctionData(
    functionFragment: "_editCEtherDelegateWhitelist",
    values: [string[], string[], boolean[], boolean[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "latestCEtherDelegate",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "_setLatestCEtherDelegate",
