...
export default class mStableSubpool {
    constructor(provider) {
        ...
        for (const contractName of Object.keys(externalContractAddressesMStable)) {
            this.externalContracts[contractName] = new Contract(externalContractAddressesMStable[contractName], externalAbisMStable[contractName]);
        }
    }
    getMUsdSavingsApy(includeIMUsdVaultApy) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = (yield axios.post("https://api.thegraph.com/subgraphs/name/mstable/mstable-protocol-staging", {
                operationName: "MUSD",
    ...
    getMtaUsdPrice() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield axios("https://api.coingecko.com/api/v3/simple/token_price/ethereum?contract_addresses=0xa3bed4e1c75d00fa6f4e5e6922db7261b5e9acd2&vs_currencies=USD")).data["0xa3bed4e1c75d00fa6f4e5e6922db7261b5e9acd2"].usd;
        });
    }
    ...
    getIMUsdVaultApy(totalStakingRewards, stakingTokenPrice) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apyBN = utils.parseUnits(utils.formatUnits(((Math.pow((weeklyROI + 1), 52) - 1) * 1e18).toFixed(0), 18), 18);
            return apyBN;
        });
    }
}
