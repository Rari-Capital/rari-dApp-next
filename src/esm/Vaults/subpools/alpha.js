      ...
      return yield this.cache.getOrUpdate("alphaIBEthApy", function () {
        return __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            const balance = yield self.provider.getBalance(
              self.externalContracts.Bank.address
            );
            // as this is no longer being used I'll leave it as is
            const interestRatePerSecondBN =
              yield self.externalContracts.ConfigurableInterestBankConfig.callStatic.getInterestRate(
                glbDebtVal,
                balance
              );
            return balance;
            ...
            throw new Error(
              "Failed to get Alpha Homora V1 interest rate: " + e
            );
          }
        });
      });
